  ...
  return (
    <div className="relative w-full max-w-sm mx-auto lg:mx-0 animate-fade-in">
      ...
      <div className="relative animate-float">
        <svg viewBox="0 0 200 280" className="w-full h-auto drop-shadow-lg" fill="none">
          {/* Body - soft pink outfit */}
          <ellipse cx="100" cy="220" rx="55" ry="45" fill="#FADADD" stroke="#E75480" strokeWidth="2" />
          <path d="M60 200 Q100 180 140 200 L135 220 Q100 210 65 220 Z" fill="#E75480" opacity="0.3" />
          
          {/* Neck */}
          <rect x="88" y="165" width="24" height="25" rx="4" fill="#FADADD" />
          
          {/* Head */}
          <circle cx="100" cy="140" r="45" fill="#FADADD" stroke="#E75480" strokeWidth="2" />
          
          {/* Beret */}
          <ellipse cx="100" cy="105" rx="38" ry="12" fill="#C2185B" />
          <ellipse cx="100" cy="100" rx="35" ry="10" fill="#E75480" />
          <circle cx="100" cy="98" r="8" fill="#F4B400" opacity="0.8" />
          
          {/* Face - eyes */}
          <ellipse cx="85" cy="138" rx="4" ry="5" fill="#1F1F1F" className="animate-pulse" />
          <ellipse cx="115" cy="138" rx="4" ry="5" fill="#1F1F1F" className="animate-pulse" />
          {/* Smile */}
          <path d="M90 152 Q100 160 110 152" stroke="#C2185B" strokeWidth="2" fill="none" strokeLinecap="round" />
          
          {/* Book */}
          <rect x="125" y="175" width="35" height="45" rx="4" fill="#FFF" stroke="#E75480" strokeWidth="1.5" transform="rotate(-15 125 175)" />
