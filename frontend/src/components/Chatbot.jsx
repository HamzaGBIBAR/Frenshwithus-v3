    ...
    <div className="fixed inset-0 z-50 flex items-end justify-end p-4 sm:p-6 pointer-events-none">
      <div className="pointer-events-auto w-full max-w-md h-[85vh] max-h-[560px] flex flex-col bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-2xl border border-pink-soft/50 dark:border-white/10 overflow-hidden animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="p-4 border-t border-pink-soft/50 dark:border-white/10">
          <div className="flex flex-col xs:flex-row gap-2 items-stretch min-w-0">
            <input
              type="text"
              value={input}
              ...
              disabled={loading}
              className="flex-1 min-w-0 px-4 py-3 rounded-xl border border-pink-soft dark:border-white/20 bg-transparent text-text dark:text-[#f5f5f5] placeholder:text-text/50 dark:placeholder:text-[#f5f5f5]/50 focus:ring-2 focus:ring-pink-primary dark:focus:ring-pink-400 focus:border-transparent"
            />
            <button
              type="submit"
              disabled={loading || !input.trim()}
              className="flex-shrink-0 px-4 py-3 min-h-[44px] bg-pink-primary dark:bg-pink-400 text-white rounded-xl hover:bg-pink-dark dark:hover:bg-pink-500 disabled:opacity-50 disabled:cursor-not-allowed transition font-medium whitespace-nowrap"
            >
              {t('chatbot.send')}
            </button>
          </div>
