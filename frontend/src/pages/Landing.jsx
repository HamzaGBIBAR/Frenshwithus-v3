...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-transparent transition-colors duration-500 relative overflow-x-hidden">
      ...
      <main className="w-full max-w-6xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 xl:px-10 3xl:px-12 pt-20 sm:pt-24 lg:pt-28 pb-10 sm:pb-16 lg:pb-24 xl:pb-28 3xl:pb-32">
        {/* Hero Section */}
        ...
        {/* Approach Section */}
        <section id="about" className="w-full py-12 sm:py-16 lg:py-24">
        ...
        {/* Testimonials – clean cards, elegant style */}
        <section className="mb-12 sm:mb-16 rounded-3xl py-12 sm:py-16 px-4 sm:px-6 lg:px-10 bg-white/50 dark:bg-[#0d0d0d]/60 backdrop-blur-sm border border-pink-soft/30 dark:border-white/5">
          <ScrollReveal>
            <h2 className="text-2xl lg:text-3xl xl:text-4xl font-bold mb-2 text-text dark:text-[#f5f5f5]">
              <span className="text-pink-primary dark:text-pink-400">{t('testimonials.title')}</span>
            </h2>
        ...
        {/* Sentinel: triggers AboutBanner when user scrolls to bottom */}
        <div ref={bottomRef} className="h-32 min-h-[128px]" aria-hidden="true" />
      </main>
    </div>
  );
}
