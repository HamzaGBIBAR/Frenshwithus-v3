  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid gap-4 md:grid-cols-2 mb-8">
        <div className="bg-white p-6 rounded-2xl border border-pink-soft/50 shadow-pink-soft card-hover">
          <h2 className="text-text/60 text-sm font-medium">Total Revenue</h2>
          <p className="text-2xl font-bold text-pink-primary mt-1">${revenue.toFixed(2)}</p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-pink-soft/50 shadow-pink-soft card-hover">
      ...
      <div className="bg-white rounded-2xl border border-pink-soft/50 shadow-pink-soft overflow-hidden">
        <div className="p-4 border-b border-pink-soft/50 flex justify-between items-center">
          <h2 className="font-semibold text-text">Recent Courses</h2>
          <Link to="/admin/courses" className="text-sm text-pink-primary hover:underline font-medium">
            View all
          </Link>
        </div>
