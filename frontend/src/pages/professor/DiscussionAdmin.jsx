  ...
  const sendMessage = async (e) => {
    ...
    try {
      if (selectedFile) {
        ...
        await api.post('/professor/global-discussion/attachment', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
      } else {
        await api.post('/professor/global-discussion', { content: content.trim() });
      }
      setContent('');
